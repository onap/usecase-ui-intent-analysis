...
public class IntentServiceImpl implements IntentService {
    ...
    public Intent createIntent(Intent intent) {
        ...
        contextService.createContextList(intent.getIntentContextList(), intent.getIntentId());
    ...
    public List<Intent> getIntentList() {
        ...
        for (Intent intent : intentList) {
            if (null != intent) {
                ...
                intent.setIntentContextList(contextService.getContextListByParentId(intentId));
